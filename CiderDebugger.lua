...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/rmoscat/Library/Application Support/luaglider2/dev";local SOCKET_PORT=43783;local GLIDER_MAIN_FOLDER= "/Users/rmoscat/Desktop/CoronaSDK/Developer/Puzzle Animals/Code Puzzle Animals";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
